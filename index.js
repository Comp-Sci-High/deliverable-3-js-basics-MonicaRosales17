...
favoriteMovie.quote = "I am awesome"
...
console.log("Ms Pham likes the movie " + favoriteMovie.name + " The genre is " + favoriteMovie.genre + ". The rating for this movie is " + favoriteMovie.rating + " and a quote that is totally from the movie is " +favoriteMovie.quote)
